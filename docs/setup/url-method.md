...
> \[!note\] sunnypilot not installed
>
> 1. [Factory reset/uninstall](https://github.com/commaai/openpilot/wiki/FAQ#how-can-i-reset-the-device) the previous software if you have another software/fork installed.
> 2. After factory reset/uninstall, upon reboot, select `Custom Software` when given the option.
> 3. Input the **Installation URL** per [Recommended Branch Installations](https://community.sunnypilot.ai/t/recommended-branch-installations/235).
> 4. Complete the rest of the installation by following the onscreen instructions.

> \[!note\] sunnypilot already installed
>
> 1. On the comma 3X, go to `Settings` → `Software`.
