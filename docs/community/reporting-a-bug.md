...
[sunnypilot's public issue tracker][sunnypilot's issue tracker] or on our [Community Forum][forum], following this guide.
...
**Don't be shy to ask on our [Community Forum][forum] for help if you run into problems.**
...
2. [Search our Community Forum][forum] to learn if other users are struggling with similar problems and work together with
   our
...
[Community Forum][forum] because it's now very likely that you stumbled over something we don't know
...
| <!-- --> | Example                                                                                                      |
| -------- |--------------------------------------------------------------------------------------------------------------|
| Y __Clear__ | Speed Limit Control (SLC) stuck in `preActive` when engaged                                                  |
| N __Wordy__ | The Speed Limit Control (SLC) remains in the `preActive` state when longitudinal it's supposed to be engaged |
| N __Unclear__ | SLC does not work                                                                                            |
| N __Useless__ | Help                                                                                                         |
...
Adhere to the following principles:
  ...
  [^3]:
    Sometimes, users report bugs on our [sunnypilot's issue tracker] or [Community Forum][forum]
    ...
    doubt, use our [Community Forum][forum] to ask for help.
...
Additionally, since you have searched [comma's issue tracker], [sunnypilot's issue tracker] or [Community Forum][forum]
...
2. Share your Dongle ID with sunnypilot on [comma Connect].
    ...
    4. Set the device name to your vehicle's year/make/model and your forum username, so it can be easily identified.
...
- [ ] I have searched the documentation, issue trackers, and Community Forum for similar issues.
