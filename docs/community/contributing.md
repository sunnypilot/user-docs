...
* Join our [Community Forum](https://community.sunnypilot.ai)

## Contributing Code

Code contributions follow a two-step process: gain access to the Development category on the forum, then open a pull request on GitHub.

### 1. Get the @external-contributor role

The [Development](https://community.sunnypilot.ai/c/development/117) category on the Community Forum requires the `@external-contributor` role. This role is granted to recognized developers with demonstrable GitHub contributions.

**How to get access:**

- **Request access** - Open a topic on the forum requesting the role. An admin will review your GitHub profile and grant access if eligible.
- **Staff invitation** - Staff members may invite contributors they recognize from GitHub activity.

### 2. Open a topic in Development

Once you have the `@external-contributor` role, open a new topic under the [Development](https://community.sunnypilot.ai/c/development/117) category to discuss your proposed change. This helps coordinate with maintainers and other contributors before writing code.

### 3. Open a pull request

After discussing your approach, open a pull request on [GitHub](https://github.com/sunnypilot/sunnypilot).
...
* Report driving issues on the [Community Forum](https://community.sunnypilot.ai).
